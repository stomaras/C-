    ...
    class Database
    {
        ...
        public Database()
        {
            ...
            for (int i = 0; i <= NumOfStudents-1; i++)
            {
                ...
                int pointOfCourse = RandomService.Number(0, Courses.Count - 1);
                Course course = Courses[pointOfCourse];
                student.Course = course;
                student.Assigments.Add(assigment1);
                student.Assigments.Add(assigment2);
                student.Assigments.Add(assigment3);
                student.Assigments.Add(assigment4);
                student.Assigments.Add(assigment5);
                student.Assigments.Add(assigment6);
                student.Assigments.Add(assigment7);
                student.Assigments.Add(assigment8);
            ...
            for (int i = 0; i <= NumOfTrainers-1; i++)
            {
                ...
                int numOfCoursesCanTrain = RandomService.Number(1, Courses.Count - 1);
                for (int j = 0; j < numOfCoursesCanTrain - 1; j++)
                {
                    int randomCourse = RandomService.Number(0, Courses.Count - 1);
                    Course courseToTrain = Courses[randomCourse];
                    
                    trainer.Courses.Add(courseToTrain);
                    courseToTrain.Trainers.Add(trainer);
                }
            ...
            for (int i = 0; i <= Courses.Count - 1; i++)
            {
                ...
                {
                    if (course.Equals(Students[j].Course))
                    {
                        course.Students.Add(Students[j]);
                    }
                }
            }
            #endregion

            #region AssigmentsPerCourse
            for (int i = 0; i < Courses.Count - 1; i++)
            {
                Course course = Courses[i];
                course.Assigments.Add(assigment1);
                course.Assigments.Add(assigment2);
                course.Assigments.Add(assigment3);
                course.Assigments.Add(assigment4);
                course.Assigments.Add(assigment5);
                course.Assigments.Add(assigment6);
                course.Assigments.Add(assigment7);
                course.Assigments.Add(assigment8);
            }

            #endregion

            #region AssigmentsPerStudent
