...
namespace PARTB.View.Menu
{
    public static class Menu
    {
        ...
        public static void ShowMenu()
        {
            ...
            Console.WriteLine($"{"Press 5 - Read Students Per Course",first}{"Press 6 - Read Trainers Per Course",second}{"Press 7 - Read Assigments Per Course",third}{"Press <<e>> or <<E>> - To exit the program",fourth}");
        }
    }
}
